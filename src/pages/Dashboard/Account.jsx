          ...
          <div>
            ...
            <div className="flex justify-between items-start mb-8">
              ...
              <div className="flex items-center">
                {/* Profile avatar */}
                <div
                  className={`w-12 h-12 rounded-full ${avatarColor} flex items-center justify-center font-medium cursor-pointer border border-[#1E293B] hover:border-[#04D2D2] transition-all duration-300`}
                  onClick={() => !isEditing && setShowAvatarModal(true)}
                >
                  {avatar}
                </div>
            ...
            <div className="mt-8 border-t border-[#1E293B] pt-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-md font-medium text-[#04D2D2]">
                  Company details
                </h3>
                <button className="text-sm text-gray-400 hover:text-[#04D2D2] flex items-center">
            ...
            <div className="mt-8 border-t border-[#1E293B] pt-6">
              ...
              <div>
                <p className="text-sm text-gray-400 mb-1">Scans deletion</p>
                <p className="text-sm text-gray-300">{userData.scanDeletion}</p>
              </div>
            </div>
          </div>
        );
            ...
            <div key={tab.id} className="mb-6">
              ...
              <div className="ml-7">
                {tab.subtabs.map((subtab) => (
                  <div
                    key={subtab.id}
                    className={`py-2 px-3 rounded-md cursor-pointer mb-2 text-sm transition-all duration-300 ${
                      activeTab === subtab.id
